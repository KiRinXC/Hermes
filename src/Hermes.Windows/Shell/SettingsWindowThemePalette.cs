...
public sealed record SettingsWindowThemePalette(
    ...
    MediaColor SegmentTrack,
    MediaColor SegmentIndicator,
    MediaColor SegmentIndicatorBorder,
    MediaColor KeycapShell,
    MediaColor Keycap,
    ...
    MediaColor ScrollBarThumbHover,
    MediaColor Accent,
...
public static class SettingsWindowThemePalettes
{
    ...
    public static SettingsWindowThemePalette Dark { get; } = new(
        ...
        SegmentTrack: MediaColor.FromArgb(0x14, 0x00, 0x00, 0x00),
        SegmentIndicator: MediaColor.FromArgb(0x26, 0xFF, 0xFF, 0xFF),
        SegmentIndicatorBorder: MediaColor.FromArgb(0x1F, 0xFF, 0xFF, 0xFF),
        KeycapShell: MediaColor.FromArgb(0x33, 0x00, 0x00, 0x00),
        ...
        ScrollBarThumb: MediaColor.FromArgb(0x33, 0xFF, 0xFF, 0xFF),
        ScrollBarThumbHover: MediaColor.FromArgb(0x66, 0xFF, 0xFF, 0xFF),
    ...
    public static SettingsWindowThemePalette Light { get; } = new(
        ...
        SegmentTrack: MediaColor.FromRgb(0xE5, 0xE5, 0xEA),
        SegmentIndicator: MediaColors.White,
        SegmentIndicatorBorder: MediaColor.FromRgb(0xD1, 0xD1, 0xD6),
        KeycapShell: MediaColor.FromRgb(0xE5, 0xE5, 0xEA),
        ...
        SliderThumb: MediaColors.White,
        ScrollBarThumb: MediaColor.FromArgb(0x52, 0x00, 0x00, 0x00),
        ScrollBarThumbHover: MediaColor.FromArgb(0x7A, 0x00, 0x00, 0x00),
        Accent: MediaColor.FromRgb(0x00, 0x7A, 0xFF),
